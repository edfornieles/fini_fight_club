...
import { applyRegimeToSignals, computeMockDailyRegime, regimeFromSignals, todayKey, } from "./dailyRegime";
...
describe("dailyRegime", () => {
    ...
    it("nudges momentum toward the regime bias", () => {
        const regime = regimeFromSignals(getManualTestSignals(), todayKey(), "mock");
