...
export const MOCK_INSTANCES: Record<string, BattleInstance> = {
  ...
  "btc-updown-hourly-resolved": {
    ...
    resolutionAuditLog: [
      ...
      { timestamp: "2026-05-31T14:00:02.100Z", event: "Payouts queued via CUTE$ ledger — idempotency key b7f3a9d2", actor: "system" },
  ...
  "sol-updown-15m-voided": {
    ...
    voidReason: "All three price sources (CoinGecko, Coinbase, Binance) returned errors or timed out at battle end. Cannot determine a fair result. All CUTE$ entries returned in full.",
    resolutionAuditLog: [
      ...
      { timestamp: "2026-05-31T11:15:02.100Z", event: "Battle voided — all CUTE$ entries returned", detail: "Return idempotency key: v9d2c5f1. Void reason recorded in audit log.", actor: "system" },
